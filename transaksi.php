...
if(isset($_SESSION['edit_kelas'])){
  echo $_SESSION['edit_kelas'];
  unset($_SESSION['edit_kelas']);
          ...
          <div class="widget-content nopadding" >
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                <?php
                  $no_order_fiks = 1;
                  $query_order_fiks = "select * from tb_pesan left join tb_program on tb_pesan.id_program = tb_program.id_program where id_user = $id_pemesan and status_pesan != 'sudah'";
