  ...
  <div class="container-fluid">
    ...
    ?>
              ...
              <div class="widget-box">
                <div class="widget-content nopadding">
                  <ul class="site-stats quick-actions">
                    ...
                    <li class="bg_ly"><i class="icon-user"></i> <strong><?php echo $result_wtr['jumlah_wtr']; ?></strong> <small>Total Magang</small></li>
                    <li class="bg_lg"><i class="icon-user"></i> <strong><?php echo $result_ksr['jumlah_ksr']; ?></strong> <small>Total Trainer</small></li>
                    <li class="bg_ls"><i class="icon-user"></i> <strong><?php echo $result_own['jumlah_own']; ?></strong> <small>Total Owner</small></li>
                    <li class="bg_lo"><i class="icon-user"></i> <strong><?php echo $result_plg['jumlah_plg']; ?></strong> <small>Total Customer</small></li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <div class="alert alert-orange alert-block">
        <center>
          <h2 class="alert-heading">SELAMAT DATANG</h2>
          <h3 class="alert-heading"> Konsultasikan Masalah Anda Disini </h3>
          </center>
          <h4 class="alert-heading">Profil People Power Academy </h4>
<br>People Power Academy atau biasa disingkat PPA adalah penyedia jasa training dan coaching yang didirikan di Bandung dengan nama resmi CV Akademi Citra Jaya. PPA didirikan oleh Kang Azmi yang merupakan trainer digital marketing bandung dan ahli public speaking yang sudah melatih banyak orang dari berbagai macam profesi untuk mencapai impiannya. Kang Azmi mempunyai sertifikasi dari Neo NLP Society sebagai NLP Trainer dan Certified NLP Coach dari NCA. Di bidang digital marketing, Kang Azmi memiliki sertifikasi digital marketing dari Escils Course USA sehingga Kang Azmi mempunyai ilmu dan skill yang dibutuhkan untuk membantu ribuan pengusaha agar bisnisnya go digital.
      </div>
      <?php
        }
      ?>
